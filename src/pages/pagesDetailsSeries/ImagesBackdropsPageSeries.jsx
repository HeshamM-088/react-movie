...
const ImagesBackdropsPageSeries = () => {
    ...
    const { loading, imagesBackdropsLanguageIt, imagesBackdropsLanguageDe, imagesBackdropsLanguageFr, imagesBackdropsLanguagePt, imagesBackdropsLanguageEn, imagesBackdropsNoLanguage, dataDetailsSeries } = useSelector(state => state.DetailsForSeries)
                                        ...
                                        <TabPanel key={index} value={value} index={index}>
                                            <div className="col-12 d-flex flex-wrap gap-5">
                                                {tab.videos.map((images, imageIndex) => (
                                                    <div key={imageIndex} className='col-2 shadow bg-dark-tertiary rounded'>
...
export default ImagesBackdropsPageSeries;
